...
#[derive(Serialize, Deserialize, Debug)]
pub struct CoAssortmentClassCodeType {
    #[serde(flatten)]
    pub co_assortment_class_code_type: AssortmentClassCodeType,
}
...
pub struct SilvicultureValidityType {
    ...
    pub start_date: DateYYYYMMOrYYYYMMDDType,
    #[serde(rename = "EndDate")]
    pub end_date: DateYYYYMMOrYYYYMMDDType,
}
...
pub struct ObjectDataGroup {
    ...
    pub control_data_water_system_protection: Option<DataWaterSystemProtection>,
    #[serde(rename = "Operations", skip_serializing_if = "Option::is_none")]
    pub op_operations: Option<Operations>,
