...
#[derive(Serialize, Deserialize, Debug)]
--pub struct WorkingSiteQualityControlSilvicultureSelfMonitoringWorkingSiteQualityControlSilvicultureType {
    #[serde(flatten)]
    pub working_site_quality_control_silviculture_self_monitoring_working_site_quality_control_silviculture_type: SelfMonitoringWorkingSiteQualityControlSilvicultureType,
}
...
#[derive(Serialize, Deserialize, Debug)]
--pub struct WorkingSiteFinalAuditSilvicultureSelfMonitoringWorkingSiteFinalAuditSilvicultureType {
    #[serde(flatten)]
    pub working_site_final_audit_silviculture_self_monitoring_working_site_final_audit_silviculture_type: SelfMonitoringWorkingSiteFinalAuditSilvicultureType,
}
...
--pub struct Documents {
    #[serde(flatten)]
    pub documents: FccDocumentsType,
}
...
#[derive(Serialize, Deserialize, Debug)]
--pub struct CoVirtaRootRotControlEvaluationType {
    #[serde(flatten)]
    pub co_virta_root_rot_control_evaluation_type: VirtaRootRotControlEvaluationType,
}
...
--pub struct CoYesNoNotKnownType {
    #[serde(flatten)]
    pub co_yes_no_not_known_type: YesNoNotKnownType,
}
...
--pub struct Xsinteger {
    #[serde(flatten)]
    pub xsinteger: integer,
}

#[derive(Serialize, Deserialize, Debug)]
--pub struct XsanyURI {
    #[serde(flatten)]
    pub xsany_u_r_i: anyURI,
}
...
#[derive(Serialize, Deserialize, Debug)]
--pub struct SpSamplePlot {
    #[serde(flatten)]
    pub sp_sample_plot: SamplePlot,
}
...
#[derive(Serialize, Deserialize, Debug)]
--pub struct AsAssortmentClassCodeType {
    #[serde(flatten)]
    pub as_assortment_class_code_type: AssortmentClassCodeType,
}
...
#[derive(Serialize, Deserialize, Debug)]
--pub struct CoStatisticsPurchaseModeCodeType {
    #[serde(flatten)]
    pub co_statistics_purchase_mode_code_type: StatisticsPurchaseModeCodeType,
}
...
#[derive(Serialize, Deserialize, Debug)]
--pub struct WorkingSiteQualityControlSoilConditioningSelfMonitoringWorkingSiteQualityControlSoilConditioningType {
    #[serde(flatten)]
    pub working_site_quality_control_soil_conditioning_self_monitoring_working_site_quality_control_soil_conditioning_type: SelfMonitoringWorkingSiteQualityControlSoilConditioningType,
}
...
#[derive(Serialize, Deserialize, Debug)]
--pub struct CoForestCentreWorkCodeType {
    #[serde(flatten)]
    pub co_forest_centre_work_code_type: ForestCentreWorkCodeType,
}
...
--pub struct StandId {
    #[serde(flatten)]
    pub stand_id: CoIdStringNotEmptyType,
}
...
--pub struct CoUseCaseType {
    #[serde(flatten)]
    pub co_use_case_type: UseCaseType,
}
...
#[derive(Serialize, Deserialize, Debug)]
--pub struct AsAssortmentCompactClassesType {
    #[serde(flatten)]
    pub as_assortment_compact_classes_type: AssortmentCompactClassesType,
}
...
#[derive(Serialize, Deserialize, Debug)]
--pub struct StStandBasicDataType {
    #[serde(flatten)]
    pub st_stand_basic_data_type: StandBasicDataType,
}
...
#[derive(Serialize, Deserialize, Debug)]
--pub struct WorkingSiteFinalAuditSoilConditioningSelfMonitoringWorkingSiteFinalAuditSoilConditioningType {
    #[serde(flatten)]
    pub working_site_final_audit_soil_conditioning_self_monitoring_working_site_final_audit_soil_conditioning_type: SelfMonitoringWorkingSiteFinalAuditSoilConditioningType,
}
...
--pub struct CoExtendedMainGroupType {
    #[serde(flatten)]
    pub co_extended_main_group_type: ExtendedMainGroupType,
}
...
#[derive(Serialize, Deserialize, Debug)]
--pub struct CoForestCentreWorkCodeGroupType {
    #[serde(flatten)]
    pub co_forest_centre_work_code_group_type: ForestCentreWorkCodeGroupType,
}
...
--pub struct CoDateYYYY-MMOrYYYY-MM-DDType {
    #[serde(flatten)]
    pub co_date_y_y_y_y-_m_m_or_y_y_y_y-_m_m-_d_d_type: DateYYYY-MMOrYYYY-MM-DDType,
}
...
--pub struct CoMeanHeightType {
    #[serde(flatten)]
    pub co_mean_height_type: MeanHeightType,
}
...
#[derive(Serialize, Deserialize, Debug)]
--pub struct CoVirtaHabitatCodeType {
    #[serde(flatten)]
    pub co_virta_habitat_code_type: VirtaHabitatCodeType,
}
...
--pub struct ExtraInfo {
    #[serde(flatten)]
    pub extra_info: TgtVirtaExtraInfoType,
}
...
#[derive(Serialize, Deserialize, Debug)]
--pub struct WorkingSiteFinalAuditPlantManagementSelfMonitoringWorkingSiteFinalAuditPlantManagementType {
    #[serde(flatten)]
    pub working_site_final_audit_plant_management_self_monitoring_working_site_final_audit_plant_management_type: SelfMonitoringWorkingSiteFinalAuditPlantManagementType,
}
...
#[derive(Serialize, Deserialize, Debug)]
--pub struct StBaseCompactStandBasicDataType {
    #[serde(flatten)]
    pub st_base_compact_stand_basic_data_type: BaseCompactStandBasicDataType,
}
...
--pub struct Document {
    #[serde(flatten)]
    pub document: Xmimebase64Binary,
}
...
--pub struct XspositiveInteger {
    #[serde(flatten)]
    pub xspositive_integer: positiveInteger,
}
...
--pub struct CoExtendedQuantityUnitType {
    #[serde(flatten)]
    pub co_extended_quantity_unit_type: ExtendedQuantityUnitType,
}
...
#[derive(Serialize, Deserialize, Debug)]
--pub struct WorkingSiteQualityControlPlantManagementSelfMonitoringWorkingSiteQualityControlPlantManagementType {
    #[serde(flatten)]
    pub working_site_quality_control_plant_management_self_monitoring_working_site_quality_control_plant_management_type: SelfMonitoringWorkingSiteQualityControlPlantManagementType,
}
...
pub struct XlinkextendedModel {
    ...
    pub xlinktitle: xlink:title,
    #[serde(rename = "Xlinkresource")]
    pub xlinkresource: xlink:resource,
    #[serde(rename = "Xlinkarc")]
    pub xlinkarc: xlink:arc,
    #[serde(rename = "Xlinklocator")]
    pub xlinklocator: xlink:locator,
}
...
pub struct ForestStatisticsDataType {
    ...
    pub rws_round_wood_sales_rows: Option<RwsRoundWoodSalesRows>,
...
pub struct ObjectDataGroup {
    ...
    pub map_symbol: Option<MapSymbol>,
    ...
    pub working_site_final_audit_draining: Option<WorkingSiteFinalAuditDraining>,
    ...
    pub working_site_final_audit_road_making: Option<WorkingSiteFinalAuditRoadMaking>,
    #[serde(rename = "SpecialFeatures", skip_serializing_if = "Option::is_none")]
    pub st_special_features: Option<StSpecialFeatures>,
}
...
pub struct arcModel {
    ...
    pub xlinktitle: Option<Vec<Xlinktitle>>,
}
...
pub struct CallForOfferWorkingSiteWoodTradeInfoType {
    ...
    pub fudr_forest_use_declaration_reference: Option<FudrForestUseDeclarationReference>,
    ...
    pub as_assortment_classes: Option<AsAssortmentClasses>,
...
pub struct SellerType {
    ...
    pub base: CiContactInformationType,
    #[serde(rename = "BankAccount", skip_serializing_if = "Option::is_none")]
    pub co_bank_account: Option<CoBankAccount>,
}
...
pub struct LineGeometryType {
    ...
    pub gml_line_string: GmlLineString,
}
...
pub struct HelpGeometriesType {
    ...
    pub hg_polygon_geometry: Option<Vec<HgPolygonGeometry>>,
    #[serde(rename = "LineGeometry", skip_serializing_if = "Option::is_none")]
    pub hg_line_geometry: Option<Vec<HgLineGeometry>>,
    #[serde(rename = "PointGeometry", skip_serializing_if = "Option::is_none")]
    pub hg_point_geometry: Option<Vec<HgPointGeometry>>,
}
