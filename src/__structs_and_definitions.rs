...
pub struct TwoDigitPositiveIntegerType {
    #[serde(rename = "two_digit_positive_integer_type.base")]
    pub base: i32,
}
...
pub struct JhsPostitoimipaikkaNimiTyyppi {
    #[serde(rename = "jhs_postitoimipaikka_nimi_tyyppi.base")]
    pub base: String,
}
...
pub struct CoVirtaAdvertiserType {
    #[serde(rename = "co_virta_advertiser_type.base")]
    pub base: String,
}
...
pub struct CoVirtaApprovalType {
    #[serde(rename = "co_virta_approval_type.base")]
    pub base: String,
}
...
pub struct CoVirtaCultivationMaterialType {
    #[serde(rename = "co_virta_cultivation_material_type.base")]
    pub base: String,
}
...
pub struct CoPaymentTypeType {
    #[serde(rename = "co_payment_type_type.base")]
    pub base: String,
}
...
pub struct CoUsedPricingMethodType {
    #[serde(rename = "co_used_pricing_method_type.base")]
    pub base: String,
}
...
pub struct JhsPostinumeroKoodiTyyppi {
    #[serde(rename = "jhs_postinumero_koodi_tyyppi.base")]
    pub base: String,
}
...
pub struct BdtCertificationSystemType {
    #[serde(rename = "bdt_certification_system_type.base")]
    pub base: String,
}
...
pub struct CoVirtaInspectionMethodType {
    #[serde(rename = "co_virta_inspection_method_type.base")]
    pub base: String,
}
...
pub struct CoVirtaHarvestingClassificationType {
    #[serde(rename = "co_virta_harvesting_classification_type.base")]
    pub base: String,
}
...
pub struct BdtString100Type {
    #[serde(rename = "bdt_string100_type.base")]
    pub base: String,
}
...
pub struct CoStandQualityType {
    #[serde(rename = "co_stand_quality_type.base")]
    pub base: String,
}
...
pub struct CoMainGroupType {
    #[serde(rename = "co_main_group_type.base")]
    pub base: String,
}
...
pub struct CallForOfferTextType {
    #[serde(rename = "call_for_offer_text_type.base")]
    pub base: String,
}
...
pub struct CoVirtaHabitatAdvertisementType {
    #[serde(rename = "co_virta_habitat_advertisement_type.base")]
    pub base: String,
}
...
pub struct JhsAlkuPvmTyyppi {
    #[serde(rename = "jhs_alku_pvm_tyyppi.base")]
    pub base: chrono::NaiveDate,
}
...
pub struct CoSeedlingOriginType {
    #[serde(rename = "co_seedling_origin_type.base")]
    pub base: String,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct CoVirtaSumTableAreaType {
    #[serde(rename = "co_virta_sum_table_area_type.base")]
    pub base: String,
}
...
pub struct CoTreeStandDataMomentType {
    #[serde(rename = "co_tree_stand_data_moment_type.base")]
    pub base: String,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct CoDateType {
    #[serde(rename = "co_date_type.base")]
    pub base: chrono::NaiveDate,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct CoVirtaReviewType {
    #[serde(rename = "co_virta_review_type.base")]
    pub base: String,
}
...
pub struct CoCuttingExtraQualifierType {
    #[serde(rename = "co_cutting_extra_qualifier_type.base")]
    pub base: String,
}
...
pub struct CoCallForOfferBusinessSenderRoleType {
    #[serde(rename = "co_call_for_offer_business_sender_role_type.base")]
    pub base: String,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct CoMainTypeType {
    #[serde(rename = "co_main_type_type.base")]
    pub base: String,
}
...
pub struct JhsYritysTunnusTyyppi {
    #[serde(rename = "jhs_yritys_tunnus_tyyppi.base")]
    pub base: String,
}
...
pub struct CoOperationModeType {
    #[serde(rename = "co_operation_mode_type.base")]
    pub base: String,
}
...
pub struct CoVirtaReasonType {
    #[serde(rename = "co_virta_reason_type.base")]
    pub base: String,
}
...
pub struct Decimal3_1Type {
    #[serde(rename = "decimal3_1_type.base")]
    pub base: f64,
}
...
pub struct StbAreaDecreaseType {
    #[serde(rename = "stb_area_decrease_type.base")]
    pub base: f64,
}
...
pub struct CoVirtaSuggestionType {
    #[serde(rename = "co_virta_suggestion_type.base")]
    pub base: String,
}
...
pub struct CoVirtaPhaseType {
    #[serde(rename = "co_virta_phase_type.base")]
    pub base: String,
}
...
pub struct CoYesNoType {
    #[serde(rename = "co_yes_no_type.base")]
    pub base: String,
}
...
pub struct Xmimebase64Binary {
    ...
    #[serde(rename = "xmimebase64_binary.base")]
    pub base: Vec<u8>,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct CoSellerGroupType {
    #[serde(rename = "co_seller_group_type.base")]
    pub base: String,
}
...
pub struct FccForestCentreMessageReferenceType {
    #[serde(rename = "fcc_forest_centre_message_reference_type.base")]
    pub base: String,
}
...
pub struct CoVirtaStandQualityType {
    #[serde(rename = "co_virta_stand_quality_type.base")]
    pub base: String,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct MaterialDeliveryTypeType {
    #[serde(rename = "material_delivery_type_type.base")]
    pub base: String,
}
...
pub struct CoYearType {
    #[serde(rename = "co_year_type.base")]
    pub base: chrono::NaiveDate,
}
...
pub struct CoAreaTypeType {
    #[serde(rename = "co_area_type_type.base")]
    pub base: String,
}
...
pub struct JhsSahkopostiosoiteTekstiTyyppi {
    #[serde(rename = "jhs_sahkopostiosoite_teksti_tyyppi.base")]
    pub base: String,
}
...
pub struct WorkingSiteNameType {
    #[serde(rename = "working_site_name_type.base")]
    pub base: String,
}
...
pub struct CoDecimal7And2PositiveType {
    #[serde(rename = "co_decimal7_and2_positive_type.base")]
    pub base: f64,
}
...
pub struct CoPositiveIntegerType {
    #[serde(rename = "co_positive_integer_type.base")]
    pub base: i32,
}
...
pub struct BdtString10Type {
    #[serde(rename = "bdt_string10_type.base")]
    pub base: String,
}
...
pub struct CoVirtaTargetSelectionType {
    #[serde(rename = "co_virta_target_selection_type.base")]
    pub base: String,
}
...
pub struct CoUsedPricingMethodTypeType {
    #[serde(rename = "co_used_pricing_method_type_type.base")]
    pub base: String,
}
...
pub struct StbStandNumberType {
    #[serde(rename = "stb_stand_number_type.base")]
    pub base: String,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct CoDecimal3And2PositiveType {
    #[serde(rename = "co_decimal3_and2_positive_type.base")]
    pub base: f64,
}
...
pub struct CoVirtaProjectStatusType {
    #[serde(rename = "co_virta_project_status_type.base")]
    pub base: String,
}
...
pub struct ProductUserIdsType {
    ...
    #[serde(rename = "ProductUserId", skip_serializing_if = "Option::is_none")]
    pub product_user_id: Option<Vec<String100Type>>,
    #[serde(flatten)]
...
pub struct CoVirtaLawType {
    #[serde(rename = "co_virta_law_type.base")]
    pub base: String,
}
...
pub struct JhsEtunimetNimiTyyppi {
    #[serde(rename = "jhs_etunimet_nimi_tyyppi.base")]
    pub base: String,
}
...
pub struct WtcoMessageTypeType {
    #[serde(rename = "wtco_message_type_type.base")]
    pub base: String,
}
...
pub struct JhsPuhelinnumeroTekstiTyyppi {
    #[serde(rename = "jhs_puhelinnumero_teksti_tyyppi.base")]
    pub base: String,
}
...
pub struct CoDecimal7And2Type {
    #[serde(rename = "co_decimal7_and2_type.base")]
    pub base: f64,
}
...
pub struct BdtString1000Type {
    #[serde(rename = "bdt_string1000_type.base")]
    pub base: String,
}
...
pub struct VirtaIdType {
    #[serde(rename = "virta_id_type.base")]
    pub base: String,
}
...
pub struct JhsKuntaKoodiTyyppi {
    #[serde(rename = "jhs_kunta_koodi_tyyppi.base")]
    pub base: String,
}
...
pub struct CoVirtaHarvestingSeasonType {
    #[serde(rename = "co_virta_harvesting_season_type.base")]
    pub base: String,
}
...
pub struct Xsbase64Binary {
    #[serde(rename = "@XmimecontentType")]
    pub xmimecontent_type: contentType,
    #[serde(rename = "xsbase64_binary.base")]
    pub base: Vec<u8>,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct StbStandNumberExtensionType {
    #[serde(rename = "stb_stand_number_extension_type.base")]
    pub base: String,
}
...
pub struct isGPSlocationType {
    #[serde(rename = "is_g_p_slocation_type.base")]
    pub base: String,
}
...
pub struct CoMeasurementMethodType {
    #[serde(rename = "co_measurement_method_type.base")]
    pub base: String,
}
...
pub struct CoVirtaPlantEvaluationType {
    #[serde(rename = "co_virta_plant_evaluation_type.base")]
    pub base: String,
}
...
pub struct CoSoilTypeType {
    #[serde(rename = "co_soil_type_type.base")]
    pub base: String,
}
...
pub struct CoPurchaseModeType {
    #[serde(rename = "co_purchase_mode_type.base")]
    pub base: String,
}
...
pub struct JhsSukuNimiTyyppi {
    #[serde(rename = "jhs_suku_nimi_tyyppi.base")]
    pub base: String,
}
...
pub struct CoMessageTypeType {
    #[serde(rename = "co_message_type_type.base")]
    pub base: String,
}
...
pub struct CoVirtaExceptionalPermitForHandlingType {
    #[serde(rename = "co_virta_exceptional_permit_for_handling_type.base")]
    pub base: String,
}
...
pub struct JhsLoppuPvmTyyppi {
    #[serde(rename = "jhs_loppu_pvm_tyyppi.base")]
    pub base: chrono::NaiveDate,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct CoCuttingDirectingType {
    #[serde(rename = "co_cutting_directing_type.base")]
    pub base: String,
}
...
pub struct CoDecimal4And2PositiveType {
    #[serde(rename = "co_decimal4_and2_positive_type.base")]
    pub base: f64,
}
...
pub struct CoVirtaDamageClassType {
    #[serde(rename = "co_virta_damage_class_type.base")]
    pub base: String,
}
...
pub struct Decimal5_1Type {
    #[serde(rename = "decimal5_1_type.base")]
    pub base: f64,
}
...
pub struct CoQuantityUnitType {
    #[serde(rename = "co_quantity_unit_type.base")]
    pub base: String,
}
...
pub struct CoDevelopmentClassType {
    #[serde(rename = "co_development_class_type.base")]
    pub base: String,
}
...
pub struct CoBearingCapacityClassType {
    #[serde(rename = "co_bearing_capacity_class_type.base")]
    pub base: String,
}
...
pub struct CoForestOwnerGroupType {
    #[serde(rename = "co_forest_owner_group_type.base")]
    pub base: String,
}
...
pub struct JhsNimiTekstiTyyppi {
    #[serde(rename = "jhs_nimi_teksti_tyyppi.base")]
    pub base: String,
}
...
#[derive(Debug, Serialize, Deserialize)]
pub struct MeasurerType {
    #[serde(rename = "measurer_type.base")]
    pub base: String,
}
...
pub struct CoVirtaTargetPartStatusType {
    #[serde(rename = "co_virta_target_part_status_type.base")]
    pub base: String,
}
...
pub struct CoVirtaInspectionTypeType {
    #[serde(rename = "co_virta_inspection_type_type.base")]
    pub base: String,
}
...
pub struct BdtString50Type {
    #[serde(rename = "bdt_string50_type.base")]
    pub base: String,
}
...
pub struct CoAccessibilityType {
    #[serde(rename = "co_accessibility_type.base")]
    pub base: String,
}
...
pub struct Decimal6_2Type {
    #[serde(rename = "decimal6_2_type.base")]
    pub base: f64,
}
...
pub struct AnnouncementIdType {
    #[serde(rename = "announcement_id_type.base")]
    pub base: String,
}
...
pub struct CoString1000Type {
    #[serde(rename = "co_string1000_type.base")]
    pub base: String,
}
...
pub struct CoCuttingTypeType {
    #[serde(rename = "co_cutting_type_type.base")]
    pub base: String,
}
...
pub struct ActorTypeSpecifierType {
    #[serde(rename = "actor_type_specifier_type.base")]
    pub base: String,
}
...
pub struct CoPercentWithFraction2Type {
    #[serde(rename = "co_percent_with_fraction2_type.base")]
    pub base: f64,
}
...
pub struct WoodLotInformationValueType {
    #[serde(rename = "wood_lot_information_value_type.base")]
    pub base: String,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct CoPositiveDecimalMax5IntegralPartMax1FractionalPartType {
    #[serde(rename = "co_positive_decimal_max5_integral_part_max1_fractional_part_type.base")]
    pub base: String,
}
...
pub struct CoFertilityClassType {
    #[serde(rename = "co_fertility_class_type.base")]
    pub base: String,
}
...
pub struct ServiceBuyerIdType {
    #[serde(rename = "service_buyer_id_type.base")]
    pub base: String,
}
...
pub struct CoIdentifierValueType {
    #[serde(rename = "co_identifier_value_type.base")]
    pub base: String,
}
...
pub struct StbStandBasicDataDateType {
    #[serde(rename = "stb_stand_basic_data_date_type.base")]
    pub base: chrono::NaiveDate,
}
...
pub struct CoVirtaGroundManipulationMethodType {
    #[serde(rename = "co_virta_ground_manipulation_method_type.base")]
    pub base: String,
}
...
pub struct FourDigitPositiveIntegerType {
    #[serde(rename = "four_digit_positive_integer_type.base")]
    pub base: i32,
}
...
pub struct CoSellerResponsible {
    #[serde(rename = "co_seller_responsible.base")]
    pub base: String,
}
...
pub struct ObjectTypeSpecifierType {
    #[serde(rename = "object_type_specifier_type.base")]
    pub base: String,
}
...
pub struct WorkingSitePriorityType {
    #[serde(rename = "working_site_priority_type.base")]
    pub base: String,
}
...
pub struct WtcoPurchaseModeType {
    #[serde(rename = "wtco_purchase_mode_type.base")]
    pub base: String,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct CoSilvicultureTypeType {
    #[serde(rename = "co_silviculture_type_type.base")]
    pub base: String,
}
...
pub struct ThreeDigitPositiveIntegerType {
    #[serde(rename = "three_digit_positive_integer_type.base")]
    pub base: i32,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct CoDecimal4And2Type {
    #[serde(rename = "co_decimal4_and2_type.base")]
    pub base: f64,
}
...
pub struct CoCuttingRestrictionType {
    #[serde(rename = "co_cutting_restriction_type.base")]
    pub base: String,
}
...
pub struct OrganizationServiceType {
    #[serde(rename = "organization_service_type.base")]
    pub base: String,
}
...
pub struct CoUnitPerHectareType {
    #[serde(rename = "co_unit_per_hectare_type.base")]
    pub base: String,
}
...
pub struct CoVirtaTotalEstimationType {
    #[serde(rename = "co_virta_total_estimation_type.base")]
    pub base: String,
}
...
pub struct CoCertificationSystemType {
    #[serde(rename = "co_certification_system_type.base")]
    pub base: String,
}
...
pub struct CoOperationNatureManagementSpecifierType {
    #[serde(rename = "co_operation_nature_management_specifier_type.base")]
    pub base: String,
}
...
pub struct OrganizationRoleType {
    #[serde(rename = "organization_role_type.base")]
    pub base: String,
}
...
pub struct StbStandInfoType {
    #[serde(rename = "stb_stand_info_type.base")]
    pub base: String,
}
...
pub struct CoStoreyType {
    #[serde(rename = "co_storey_type.base")]
    pub base: String,
}
...
pub struct CoVirtaHabitatTypeType {
    #[serde(rename = "co_virta_habitat_type_type.base")]
    pub base: String,
}
...
pub struct CoForestCentreUnitType {
    #[serde(rename = "co_forest_centre_unit_type.base")]
    pub base: String,
}
...
pub struct CoTreeSpeciesType {
    #[serde(rename = "co_tree_species_type.base")]
    pub base: String,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct CoVirtaRegenerationType {
    #[serde(rename = "co_virta_regeneration_type.base")]
    pub base: String,
}
...
pub struct CoStemTypeType {
    #[serde(rename = "co_stem_type_type.base")]
    pub base: String,
}
...
pub struct CoSilvicultureExtraQualifierType {
    #[serde(rename = "co_silviculture_extra_qualifier_type.base")]
    pub base: String,
}
...
pub struct CoVirtaEvaluationType {
    #[serde(rename = "co_virta_evaluation_type.base")]
    pub base: String,
}
...
pub struct CoPositiveInteger5digitsType {
    #[serde(rename = "co_positive_integer5digits_type.base")]
    pub base: i32,
}
...
pub struct CoVirtaMastoInspectionType {
    #[serde(rename = "co_virta_masto_inspection_type.base")]
    pub base: String,
}
...
pub struct CoWoodLotInformationTypeType {
    #[serde(rename = "co_wood_lot_information_type_type.base")]
    pub base: String,
}
...
pub struct CoVirtaWorkQualityType {
    #[serde(rename = "co_virta_work_quality_type.base")]
    pub base: String,
}
...
pub struct CoStatisticsOperationType {
    #[serde(rename = "co_statistics_operation_type.base")]
    pub base: String,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct CoCurrencyType {
    #[serde(rename = "co_currency_type.base")]
    pub base: String,
}
...
pub struct XshexBinary {
    #[serde(rename = "@XmimecontentType")]
    pub xmimecontent_type: contentType,
    #[serde(rename = "xshex_binary.base")]
    pub base: Vec<u8>,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct CoString1500Type {
    #[serde(rename = "co_string1500_type.base")]
    pub base: String,
}
...
pub struct CoProposalTypeType {
    #[serde(rename = "co_proposal_type_type.base")]
    pub base: String,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct CoPercentWithFraction1Type {
    #[serde(rename = "co_percent_with_fraction1_type.base")]
    pub base: f64,
}
...
pub struct CoReferenceType {
    #[serde(rename = "co_reference_type.base")]
    pub base: String,
}
...
pub struct CoVirtaSaveIncompleteType {
    #[serde(rename = "co_virta_save_incomplete_type.base")]
    pub base: String,
}
...
pub struct CoOperationUrgencyType {
    #[serde(rename = "co_operation_urgency_type.base")]
    pub base: String,
}
...
pub struct BdtString20Type {
    #[serde(rename = "bdt_string20_type.base")]
    pub base: String,
}
...
pub struct CoSubGroupType {
    #[serde(rename = "co_sub_group_type.base")]
    pub base: String,
}
...
pub struct WorkingSiteIdType {
    #[serde(rename = "working_site_id_type.base")]
    pub base: String,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct CoDecimal1FractionDigitType {
    #[serde(rename = "co_decimal1_fraction_digit_type.base")]
    pub base: f64,
}
...
pub struct CoVATStatusType {
    #[serde(rename = "co_v_a_t_status_type.base")]
    pub base: String,
}
...
pub struct CoDeadTreeTypeType {
    #[serde(rename = "co_dead_tree_type_type.base")]
    pub base: String,
}
...
pub struct CoDecimal2FractionDigitsType {
    #[serde(rename = "co_decimal2_fraction_digits_type.base")]
    pub base: f64,
}
...
pub struct CoTreeClassType {
    #[serde(rename = "co_tree_class_type.base")]
    pub base: String,
}
...
pub struct CoMeasurementCertificateTypeType {
    #[serde(rename = "co_measurement_certificate_type_type.base")]
    pub base: String,
}
...
pub struct CoDrainageStateType {
    #[serde(rename = "co_drainage_state_type.base")]
    pub base: String,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct CoPublicityType {
    #[serde(rename = "co_publicity_type.base")]
    pub base: String,
}
...
pub struct CoTimeStampType {
    #[serde(rename = "co_time_stamp_type.base")]
    pub base: chrono::NaiveDateTime,
}
...
pub struct CoDocumentClassType {
    #[serde(rename = "co_document_class_type.base")]
    pub base: String,
}
...
pub struct CoVirtaCuttingByMachineType {
    #[serde(rename = "co_virta_cutting_by_machine_type.base")]
    pub base: String,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct CoVirtaAdvertisementDatingType {
    #[serde(rename = "co_virta_advertisement_dating_type.base")]
    pub base: String,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct CoVirtaHabitatSurvivingType {
    #[serde(rename = "co_virta_habitat_surviving_type.base")]
    pub base: String,
}
