...
pub struct DataColumnDefinition {
    #[serde(flatten)]
    pub data_column_definition: DataColumnDefinitionType,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct UserDefinedDataDefinition {
    #[serde(flatten)]
...
#[derive(Serialize, Deserialize, Debug)]
pub struct UserDefinedDataInstructionHeader {
    #[serde(flatten)]
    pub user_defined_data_instruction_header: MessageHeaderType,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct UserDefinedDataInstruction {
    #[serde(flatten)]
    pub user_defined_data_instruction: UserDefinedDataInstructionType,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct DataCellDefinition {
    #[serde(flatten)]
    pub data_cell_definition: DataCellDefinitionType,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct DataEnumDefinition {
    #[serde(flatten)]
    pub data_enum_definition: DataEnumDefinitionType,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct DataRowDefinition {
    #[serde(flatten)]
    pub data_row_definition: DataRowDefinitionType,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct DataTableGroupDefinition {
    #[serde(flatten)]
    pub data_table_group_definition: DataTableGroupDefinitionType,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct DataTableDefinition {
    #[serde(flatten)]
    pub data_table_definition: DataTableDefinitionType,
}
