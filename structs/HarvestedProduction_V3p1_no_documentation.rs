...
pub struct StemVolume {
    #[serde(flatten)]
    pub stem_volume: StemVolumeType,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct ReferenceDiameter {
    #[serde(flatten)]
    pub reference_diameter: ReferenceDiameterType,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct DiameterSectionDefinition {
    #[serde(flatten)]
    pub diameter_section_definition: DiameterSectionDefinitionMachineType,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct StemDiameters {
    #[serde(flatten)]
    pub stem_diameters: StemDiametersType,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct SingleTreeProcessedStem {
    #[serde(flatten)]
    pub single_tree_processed_stem: SingleTreeProcessedStemType,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct HarvestedProductionHeader {
    #[serde(flatten)]
    pub harvested_production_header: MessageHeaderType,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct MultiTreeFelledStem {
    #[serde(flatten)]
    pub multi_tree_felled_stem: MultiTreeFelledStemType,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct HarvestedProduction {
    #[serde(flatten)]
    pub harvested_production: HarvestedProductionType,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct MultiTreeProcessedStem {
    #[serde(flatten)]
...
#[derive(Serialize, Deserialize, Debug)]
pub struct StemGrade {
    #[serde(flatten)]
    pub stem_grade: StemGradeType,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct StemBunchKey {
    #[serde(flatten)]
    pub stem_bunch_key: XsdpositiveInteger,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct SingleTreeFelledStem {
    #[serde(flatten)]
    pub single_tree_felled_stem: SingleTreeFelledStemType,
}
